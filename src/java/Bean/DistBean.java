...
//What
    ...
    private String TotalNumberHouseholds;
    private String AverageCostPerHouseholds;
    private String FemaleHeadedHouseholds;
    private String VulnerableCasteEthnicityHouseholds;
...
//when
    ...
    public String getTotalNumberHouseholds() {
        return TotalNumberHouseholds;
    }

    public void setTotalNumberHouseholds(String TotalNumberHouseholds) {
        this.TotalNumberHouseholds = TotalNumberHouseholds;
    }

    public String getAverageCostPerHouseholds() {
        return AverageCostPerHouseholds;
    }

    public void setAverageCostPerHouseholds(String AverageCostPerHouseholds) {
        this.AverageCostPerHouseholds = AverageCostPerHouseholds;
    }

    public String getFemaleHeadedHouseholds() {
        return FemaleHeadedHouseholds;
    }

    public void setFemaleHeadedHouseholds(String FemaleHeadedHouseholds) {
        this.FemaleHeadedHouseholds = FemaleHeadedHouseholds;
    }

    public String getVulnerableCasteEthnicityHouseholds() {
        return VulnerableCasteEthnicityHouseholds;
    }

    public void setVulnerableCasteEthnicityHouseholds(String VulnerableCasteEthnicityHouseholds) {
        this.VulnerableCasteEthnicityHouseholds = VulnerableCasteEthnicityHouseholds;
    }
